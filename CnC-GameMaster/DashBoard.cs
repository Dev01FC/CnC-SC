...
namespace CnCGameMaster
{
    ...
    public partial class DashBoard : Form, IFireDelegate
    {
        ...
        public DashBoard()
        {
            ...
            Settings mySettings = CnC.Helpers.Cache.LoadObject<Settings>(SETTINGSPATH); //Load from JSon 
            if (mySettings == null)
            {
        ...
        {
            Game game = (Game)this.fdGames.Items.Where(c => c.Id == lbxGames.SelectedItem.ToString()).First();
            game.Name = "Mega Game";
            game.Save(this.FAppPublic);
        }
